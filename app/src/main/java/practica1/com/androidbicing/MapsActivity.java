...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        {
            double lat = Double.parseDouble(cursor.getString(cursor.getColumnIndex(StationsColumns.LATITUDE)));
            double lng = Double.parseDouble(cursor.getString(cursor.getColumnIndex(StationsColumns.LONGITUDE)));
